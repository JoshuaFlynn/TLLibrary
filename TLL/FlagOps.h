...
/*
Notes:
Made the AreFlagsEnabled and AreFlagsDisabled functions more efficient
...
inline const bool AreFlagsEnabled(const TItem &BitFlags, const TItem2 &Flags)
{
    return (BitFlags&Flags) == Flags;
}

template<typename TItem, typename TItem2>
inline const bool AreFlagsDisabled(const TItem &BitFlags, const TItem2 &Flags)
{
    return (BitFlags&Flags) != 0;
}
