...
Find function fixed per my request (I forgot to add in CurrTo, note to past self).
Added CurrItemNext and Prev (perhaps a more universal function for this so it works regardless of node?)
*/
...
class TemplateList : public TemplateIterator<TemplateItem>
{
	...
	public:
        ...
        */
        ...
        inline TemplateItem &GetCurrItemPrev(){return Curr->Prev->Item;}
        inline TemplateItem &GetCurrItemNext(){return Curr->Next->Item;}
